...
/**
 * @brief A function to bind a log handle to sampler config. The log handle
 *        will also be bound to any dialog handle created from this sampler config handle.
 *
 ...
 */
GENIE_API
Genie_Status_t GenieSamplerConfig_bindLogger(const GenieSamplerConfig_Handle_t configHandle,
